...
MHW_events <- detect_event(climatelogy_tresh)
MCS_events <- detect_event(climatelogy_tresh,coldSpells = T)
event_line(MHW_events,start_date = "2021-12-01", end_date = "2023-06-30",spread=500)
write.csv(MHW_events$event,"MHW_Events_ISR.csv")
