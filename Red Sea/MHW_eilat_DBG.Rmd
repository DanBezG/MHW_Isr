...
MHW_daily_distance_df <- MHW_daily_distance_df %>%
  ...
  summarise(
    ...
    night_displacement_6 =
      {
      filter_distances <- distance_shore[Period == "Day" | Period == "Dusk" | Period =="Dawn"]
...
mhw_distance <- sum_heat_wave %>%
  filter(!is.na(distance_shore_mean))
...
layout <- c(
  ...
  area(t = 2, l = 1, b = 2, r = 1),  # bottom-left (1/3 width)
  area(t = 2, l = 2, b = 2, r = 3)   # bottom-right (2/3 width)
)
